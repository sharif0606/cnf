@extends('layout.app')
@section('pageTitle',trans('Others Collection'))
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" method="get" action="">
                            ...
                            <div class="row m-4 no_print">
                                ...
                                <div class="col-6 d-flex justify-content-Start">
                                    <a href="{{route(currentUser().'.othersPay.index')}}" class="btn pbtn btn-sm btn-warning me-1 mb-1 ps-5 pe-5">{{__('Reset')}}</a>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <a class="float-end" href="{{route(currentUser().'.othersPay.create')}}"style="font-size:1.7rem"><i class="bi bi-plus-square-fill"></i></a>
                            </div>
                        </div>
                        <!-- table bordered -->
                            ...
                            <table class="table table-bordered mb-0">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">{{__('Receive From')}}</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="white-space-nowrap">
                                            <a href="{{route(currentUser().'.othersPay.edit',encryptor('encrypt',$p->id))}}">
                                                <i class="bi bi-pencil-square"></i>
                                            </a>
                                            {{-- <a href="javascript:void()" onclick="$('#form{{$p->id}}').submit()">
                                                <i class="bi bi-trash"></i>
                                            </a>
                                            <form id="form{{$p->id}}" action="{{route(currentUser().'.othersPay.destroy',encryptor('encrypt',$p->id))}}" method="post">
                                                @csrf
                                                @method('delete')
                                            </form> --}}
                                        </td>
