...
<div class="container">
    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        <div  class="tab-pane fade" id="step-2" role="tabpanel" aria-labelledby="step-2-tab">
            <div class="text-center">
                <button class="btn btn-sm btn-info" onclick="printDiv('result_show_two')">Print</button>
            </div>
        ...
        <div class="tab-pane fade" id="step-3" role="tabpanel" aria-labelledby="step-3-tab">
            <div class="text-center">
                <button class="btn btn-sm btn-info" onclick="printDiv('result_show_three')">Print</button>
            </div>
