...
<div class="container">
    <div class="d-flex justify-content-between">
        <button type="button" class="btn btn-primary btn-selected"  id="form-one">ফরম-৫৫ (ক)</button>
        <button class="btn btn-primary" onclick="buttonFunntionTwo" id="form-two">ফরম-৫৫ (ক)</button>
        <button class="btn btn-primary" onclick="buttonFunntionThree" id="form-three">ফরম-৫৫ (ক)</button>
    </div>
