                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select onchange="pre_designation(this)" name="designation_of_present_job" class="form-control designation_of_present_job">
                                            <option value="">Select</option>
                                            <option value="কাস্টম সরকার" {{ old('designation_of_present_job',$member->designation_of_present_job)=='কাস্টম সরকার' ? 'selected':''}}>কাস্টম সরকার</option>
                                            <option value="জেটি সরকার" {{ old('designation_of_present_job',$member->designation_of_present_job)=='জেটি সরকার' ? 'selected':''}}>জেটি সরকার</option>
                                            <option value="জেটি/কাস্টম সরকার" {{ old('designation_of_present_job',$member->designation_of_present_job)=='জেটি/কাস্টম সরকার' ? 'selected':''}}>জেটি/কাস্টম সরকার</option>
                                            <option value="4" {{ old('designation_of_present_job',$member->designation_of_present_job)=='4' ? 'selected':''}}>অন্যান্য</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6 others_designation d-none">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="others_designation" value="{{old('others_designation',$member->others_designation)}}">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-12 d-flex justify-content-end">
                                    <button type="submit" id="submitBtn" class="btn btn-info me-1">Update</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    $(document).ready(function() {
        $('.designation_of_present_job').each(function() {
            pre_designation(this);
        });
    });
