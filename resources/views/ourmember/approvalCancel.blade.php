@extends('layout.app')
@section('pageTitle',trans('Approval Cancel Section'))
@section('pageSubTitle',trans('approval'))
@push("styles")
...
<div class="container">
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="step-1" role="tabpanel" aria-labelledby="step-1-tab">
            ...
            <form method="post" action="{{route(currentUser().'.to_approve_cancel',encryptor('encrypt',$show_data->id))}}">
                @csrf
                <div class="text-center">
                    <button type="submit" class="btn btn-danger me-1">Cancel</button>
                </div>
            </form>
        </div>
    </div>
